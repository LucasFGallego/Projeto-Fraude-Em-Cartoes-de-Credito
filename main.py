...
caminho_csv = 'creditcardReduzida.csv'
...
with st.container():
    ...
    st.image('foto1.jpg', caption='Fonte: Designed by FreePik')
...
with st.container():
    ...
    st.image('grafico_1.png', caption='Fonte: Autores')
...
with st.container():
    ...
    st.write('A seguir serão expostos os resultados obtidos pelo modelo.Ainda, ressalta-se que o modelo utilizado foi o Random Forest Classifier, um algoritmo de aprendizado de máquina de ensemble que utiliza múltiplas árvores de decisão para melhorar a precisão e reduzir o risco de overfitting.')
    st.image('grafico_2.png', caption='Fonte: Autores')
...
with st.container():
    st.write('---')
    st.subheader('Projeto realizado por:')
    st.write('Lucas Fernandez Gallego - Linkedin:  [https://www.linkedin.com/in/lucas-fernandez-gallego-4a6144232](https://www.linkedin.com/in/lucas-fernandez-gallego/).')
    st.write('Nicolas Andreatti de Santana - Linkedin:   [https://www.linkedin.com/in/niiandreatti/](https://www.linkedin.com/in/niiandreatti/).')